...
const DEFAULT_REPLACEMENTS = [
  ...
  ['next-web', 'swift-web'],
  ['Hermes Agent', 'Tideline Agent'],
  ['hermes-agent', 'tideline-agent'],
  ['HermesAgent', 'TidelineAgent'],
  ['HERMES', 'TIDELINE'],
  ['Hermes', 'Tideline'],
  ['hermes-gateway', 'tideline-gateway'],
  ['hermes', 'tideline'],
  ['SOUL.md', 'SPARK.md'],
  ['NousResearch', 'LumeonLabs'],
  ['nousresearch', 'lumeonlabs'],
  ['Nous Research', 'Lumeon Labs'],
  ['Nous Portal', 'Lumeon Portal'],
  ['nous portal', 'lumeon portal'],
  ['NOUS_', 'LUMEON_'],
...
const DEFAULT_REVERSE_MAP = [
  ...
  ['Swiftline', 'NextChat'],
  ['swiftline', 'nextchat'],
  ['Tideline Agent', 'Hermes Agent'],
  ['tideline-agent', 'hermes-agent'],
  ['TidelineAgent', 'HermesAgent'],
  ['TIDELINE', 'HERMES'],
  ['Tideline', 'Hermes'],
  ['tideline-gateway', 'hermes-gateway'],
  ['tideline', 'hermes'],
  ['SPARK.md', 'SOUL.md'],
  ['LumeonLabs', 'NousResearch'],
  ['lumeonlabs', 'nousresearch'],
  ['Lumeon Labs', 'Nous Research'],
  ['Lumeon Portal', 'Nous Portal'],
  ['lumeon portal', 'nous portal'],
  ['LUMEON_', 'NOUS_'],
  ['lumeonlabs.io', 'nousresearch.com'],
  ['Tessera', 'OpenClaw'],
  ['tessera', 'openclaw'],
];
